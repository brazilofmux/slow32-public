...
| ~~1~~ | ~~a subscripted `SOURCE` in a report line~~ **landed** (Stage 17); gl008's 2002 leftovers (`ROUNDED MODE` -- half-to-even written out in 85, table `SORT`, a subscripted subscript) rewritten in majesty 2026-08-30 -- **gl008 runs on SLOW-32, all 22 receipts identical to GnuCOBOL** | ~~gl008~~; gl015, gl016 (retired) stop at a report field without a PICTURE |
