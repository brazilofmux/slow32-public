...
TEST_IN="${STAGE8_TEST_IN:-$SCRIPT_DIR/tests_cc/min_main.c}"
TEST_RET_IN="${STAGE8_TEST_RET_IN:-$SCRIPT_DIR/tests_cc/min_ret7.c}"
TEST_EXPR_IN="${STAGE8_TEST_EXPR_IN:-$SCRIPT_DIR/tests_cc/min_ret_expr.c}"
TEST_LOCAL_IN="${STAGE8_TEST_LOCAL_IN:-$SCRIPT_DIR/tests_cc/min_local_ret_expr.c}"
TEST_REL_IN="${STAGE8_TEST_REL_IN:-$SCRIPT_DIR/tests_cc/min_ret_rel.c}"
TEST_IF_TRUE_IN="${STAGE8_TEST_IF_TRUE_IN:-$SCRIPT_DIR/tests_cc/min_if_true.c}"
TEST_IF_FALSE_IN="${STAGE8_TEST_IF_FALSE_IN:-$SCRIPT_DIR/tests_cc/min_if_false.c}"
TEST_WHILE_IN="${STAGE8_TEST_WHILE_IN:-$SCRIPT_DIR/tests_cc/min_while_countdown.c}"
TEST_TWO_LOCALS_IN="${STAGE8_TEST_TWO_LOCALS_IN:-$SCRIPT_DIR/tests_cc/min_two_locals.c}"
TEST_HELPER_IN="${STAGE8_TEST_HELPER_IN:-$SCRIPT_DIR/tests_cc/min_helper_call.c}"
TEST_HELPER_ARG_IN="${STAGE8_TEST_HELPER_ARG_IN:-$SCRIPT_DIR/tests_cc/min_helper_arg.c}"
TEST_HELPER_LOCAL_IN="${STAGE8_TEST_HELPER_LOCAL_IN:-$SCRIPT_DIR/tests_cc/min_helper_local.c}"
TEST_MAIN_LOCAL_HELPER_IN="${STAGE8_TEST_MAIN_LOCAL_HELPER_IN:-$SCRIPT_DIR/tests_cc/min_main_local_helper.c}"
TEST_HELPER_TWO_ARGS_IN="${STAGE8_TEST_HELPER_TWO_ARGS_IN:-$SCRIPT_DIR/tests_cc/min_helper_two_args.c}"
TEST_HELPER_TWO_ARGS_IF_IN="${STAGE8_TEST_HELPER_TWO_ARGS_IF_IN:-$SCRIPT_DIR/tests_cc/min_helper_two_args_if.c}"
TEST_MULTI_FUNC_IN="$SCRIPT_DIR/tests_cc/min_multi_func.c"
TEST_FOR_LOOP_IN="$SCRIPT_DIR/tests_cc/min_for_loop.c"
TEST_NESTED_IF_IN="$SCRIPT_DIR/tests_cc/min_nested_if.c"
TEST_BREAK_CONTINUE_IN="$SCRIPT_DIR/tests_cc/min_break_continue.c"
TEST_GENERAL_NAMES_IN="$SCRIPT_DIR/tests_cc/min_general_names.c"
TEST_COMPLEX_EXPR_IN="$SCRIPT_DIR/tests_cc/min_complex_expr.c"
TEST_CHAR_TYPE_IN="$SCRIPT_DIR/tests_cc/min_char_type.c"
TEST_CHAR_LITERAL_IN="$SCRIPT_DIR/tests_cc/min_char_literal.c"
TEST_LOCAL_ARRAY_IN="$SCRIPT_DIR/tests_cc/min_local_array.c"
TEST_CHAR_ARRAY_IN="$SCRIPT_DIR/tests_cc/min_char_array.c"
TEST_STRING_LIT_IN="$SCRIPT_DIR/tests_cc/min_string_lit.c"
TEST_POINTER_IN="$SCRIPT_DIR/tests_cc/min_pointer.c"
TEST_GLOBAL_IN="$SCRIPT_DIR/tests_cc/min_global.c"
TEST_GLOBAL_ARRAY_IN="$SCRIPT_DIR/tests_cc/min_global_array.c"
TEST_PTR_ARITH_IN="$SCRIPT_DIR/tests_cc/min_ptr_arith.c"
TEST_SHORT_CIRCUIT_IN="$SCRIPT_DIR/tests_cc/min_short_circuit.c"
TEST_TYPEDEF_IN="$SCRIPT_DIR/tests_cc/min_typedef.c"
TEST_TYPEDEF_STRUCT_IN="$SCRIPT_DIR/tests_cc/min_typedef_struct.c"
TEST_STRUCT_BASIC_IN="$SCRIPT_DIR/tests_cc/min_struct_basic.c"
TEST_STRUCT_ARROW_IN="$SCRIPT_DIR/tests_cc/min_struct_arrow.c"
TEST_STRUCT_ARRAY_IN="$SCRIPT_DIR/tests_cc/min_struct_array.c"
TEST_SIZEOF_IN="$SCRIPT_DIR/tests_cc/min_sizeof.c"
TEST_SIZEOF_STRUCT_IN="$SCRIPT_DIR/tests_cc/min_sizeof_struct.c"
TEST_CAST_IN="$SCRIPT_DIR/tests_cc/min_cast.c"
TEST_DEFINE_IN="$SCRIPT_DIR/tests_cc/min_define.c"
TEST_DEFINE_HEX_IN="$SCRIPT_DIR/tests_cc/min_define_hex.c"
TEST_ENUM_IN="$SCRIPT_DIR/tests_cc/min_enum.c"
TEST_PROTOTYPE_IN="$SCRIPT_DIR/tests_cc/min_prototype.c"
TEST_INCLUDE_IN="$SCRIPT_DIR/tests_cc/min_include.c"
TEST_INCLUDE_HELPER_IN="$SCRIPT_DIR/tests_cc/min_include_helper.h"
KEEP_ARTIFACTS=0
...
# the pipeline uses the make-built stage02 assembler in place (it no
# longer copies it into the artifacts dir); s32-ar is built per-run
...
# run-spike.sh is gone; the C linker is the make-built stage02 artifact
LD_EXE="$SELFHOST_DIR/stage02/s32-ld.s32x"
[[ -f "$LD_EXE" ]] || { echo "missing stage02 linker exe: $LD_EXE (run 'make' in stage02 first)" >&2; exit 1; }
