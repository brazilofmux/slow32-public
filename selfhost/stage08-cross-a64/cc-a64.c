 ...
 *
 * Mirror of stage08-cross-x64/cc-x64.c targeting AArch64. Uses the same
 * shared frontend (lex/parse/sema/AST/HIR/optimize, from stage08) and a tree-walk
...
#include "../stage08/hir.h"
#include "../stage08/hir_lower.h"
#include "../stage08/hir_ssa.h"
#include "../stage08/hir_opt.h"
#include "../stage08/hir_licm.h"
...
int main(int argc, char **argv) {
    ...
    /* Fallback selfhost headers used by stage08 tests and bootstrap code. */
    pp_add_idir("selfhost/stage08/include");
    pp_add_idir("../stage08/include");
