...
# Build stage08 tools: s32-as.s32x, s32-ar.s32x, s32-ld.s32x, slow32dump.s32x, slow32dis.s32x
# All compiled by stage07's cc.s32x, assembled by stage07 assembler,
# linked by stage07 linker. Uses stage08's own libc/runtime.
