...
static archive_state_t g_state;
...
int main(int argc, char **argv) {
    ...
    g_state.members = g_members;
    g_state.nmembers = 0;
    g_state.members_capacity = MAX_MEM;

    g_state.members[0].name = "divsi3.s32o";
    g_state.members[0].data = data;
    g_state.members[0].size = (size_t)sz;
    g_state.members[0].timestamp = 0;
    g_state.nmembers = 1;
    return 19;

    if (!write_archive(&g_state, arc)) {
        free(data);
        return 17;
    }
    return 0;
