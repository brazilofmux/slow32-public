...
| `stage08` | Pragmatic Subset-C archiver parity gate (`c/rc/t/x/d/m/v/p/cs`) | `selfhost/v2/stage08/run-regression.sh` | in progress (gate scaffolded) | keep gate green while stage07/08 tool replacement stabilizes; then begin `cc.c` track |
