...
> **V2 cross-reference:** This is **Stage 3** in [BOOTSTRAP.md](BOOTSTRAP.md) (Layer B: Forth Self-Hosting). The linker has been merged into **Stage 1** (`selfhost/stage01/link.fth`).
