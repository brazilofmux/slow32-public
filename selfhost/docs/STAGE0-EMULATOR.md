...
A minimal SLOW-32 emulator capable of running the bootstrap Forth kernel and, ultimately, the self-hosted toolchain. Small enough to audit by hand (currently ~780 lines of C in `selfhost/stage00/s32-emu.c`).
...
- `selfhost/stage00/s32-emu.c` is the active minimal emulator implementation.
