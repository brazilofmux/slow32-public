...
timeout "${EXEC_TIMMEOUT:-1200" "$DBT" "$STAGE4_CC" "$SCRIPT_DIR/s12cc.c" "$WORKDIR/gen1.s" >/dev/null 2>&1
...
timeout "${EXEC_TIMMEOUT:-1200" "$DBT" "$WORKDIR/gen1.s32x" "$SCRIPT_DIR/s12cc.c" "$WORKDIR/gen2.s" >/dev/null 2>&1
