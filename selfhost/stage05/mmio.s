...
# ============================================================================
# MMIO Helper (returns pointer to MMIO data buffer for C code)
# ============================================================================

.global __get_mmio_data
__get_mmio_data:
    lui r1, %hi(__mmio_base+16384)
    addi r1, r1, %lo(__mmio_base+16384)
    jalr r0, lr, 0

# Minimal fallback — libc/start.s32o overrides this via first-definition-wins
