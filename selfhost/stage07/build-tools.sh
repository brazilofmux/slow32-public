...
# Build stage07 tools: s32-as.s32x, s32-ar.s32x, s32-ld.s32x, slow32dump.s32x, slow32dis.s32x
# All compiled by stage06's cc.s32x, assembled by stage06 assembler,
# linked by stage06 linker. Uses stage07's own libc/runtime.
...
WORKDIR="$(mktemp -d /tmp/stage07-tools.XXXXXX)"
