...
# Link with MMIO libc
echo -n "  Linking... "
$LD --mmio 64K --stack-size 128K --data-size 4M --heap-size 16M -o dbase.s32x \
    ../runtime/crt0.s32o \
    $OBJECTS \
...
echo "  echo 'QUIT' | ../tools/emulator/slow32-fast dbase.s32x"
