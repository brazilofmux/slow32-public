...
echo "=== Building SLOW-32 Asteroids ==="

OBJECTS=""
for src in src/vfont.c src/asteroids.c; do
    base=$(basename "$src" .c)
...
echo -n "  Linking... "
$LD --mmio 64K --stack-size 64K --data-size 1M -o asteroids.s32x \
    ../runtime/crt0.s32o \
    $OBJECTS \
...
echo ""
echo "Success! Start the game, then attach the glass:"
echo "  ../tools/emulator/slow32-fast asteroids.s32x &"
echo "  ../tools/s32-crt/s32-crt"
