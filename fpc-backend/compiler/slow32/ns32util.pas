{
    ...
    SLOW-32 version of some node tree helper routines
...
interface
  ...
  type
    ts32nodeutils = class(tnodeutils)
    protected
...
implementation
  ...
  class procedure ts32nodeutils.insert_init_final_table(main: tmodule; entries:tfplist);
    ...
    procedure genentry(list : TAsmList);
      ...
      begin
        ...
        ref.offset:=12;
        list.Concat(taicpu.op_reg_ref(A_STW,NR_RETURN_ADDRESS_REG,ref));
      end;
    ...
    procedure genexit(list : TAsmList);
      ...
      begin
        ...
        ref.base:=NR_STACK_POINTER_REG;
        ref.offset:=12;
        list.Concat(taicpu.op_reg_ref(A_LDW,NR_RETURN_ADDRESS_REG,ref));
