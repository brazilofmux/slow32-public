...
.Lfunc_end16:
	.size	f77_rd_end, .Lfunc_end16-f77_rd_end
                                        # -- End function
	.globl	f77_ipow                        # -- Begin function f77_ipow
	.p2align	2
	.type	f77_ipow,@function
f77_ipow:                               # @f77_ipow
# %bb.0:
	addi r1, r0, 1
	addi r5, r0, 0
...
.LBB17_8:
	jalr r0, r31, 0
.Lfunc_end17:
	.size	f77_ipow, .Lfunc_end17-f77_ipow
                                        # -- End function
	.section	.rodata.cst8,"aM",@progbits,8
	.p2align	2, 0x0                          # -- Begin function f77_dpow_i
...
.LCPI18_0:
	...
	.globl	f77_dpow_i
	.p2align	2
	.type	f77_dpow_i,@function
f77_dpow_i:                             # @f77_dpow_i
# %bb.0:
	addi sp, sp, -32
	stw sp+0, lr
	stw sp+28, r11
...
.LBB18_3:
	...
	jalr r0, r31, 0
.Lfunc_end18:
	.size	f77_dpow_i, .Lfunc_end18-f77_dpow_i
                                        # -- End function
	.section	.rodata.cst4,"aM",@progbits,4
	.p2align	2, 0x0                          # -- Begin function f77_rpow_i
...
.LCPI19_0:
	...
	.globl	f77_rpow_i
	.p2align	2
	.type	f77_rpow_i,@function
f77_rpow_i:                             # @f77_rpow_i
# %bb.0:
	lui r8, %hi(.LCPI19_0)
	addi r8, r8, %lo(.LCPI19_0)
	ldw r1, r8+0
	addi r5, r0, 0
	add r6, r1, r0
	beq r4, r5, .LBB19_3
...
.LBB19_3:
	...
	jalr r0, r31, 0
.Lfunc_end19:
	.size	f77_rpow_i, .Lfunc_end19-f77_rpow_i
                                        # -- End function
...
.LBB20_10:
	...
	stw r14+0, r15
.LBB20_11:
	beq r13, r15, .LBB20_41
.LBB20_12:
	blt r12, r16, .LBB20_41
.LBB20_13:
	addi r4, r0, 0
	addi r3, r0, 3
	lui r5, %hi(.L.str.9)
...
.LBB20_40:
	...
	jal r0, .LBB20_58
.LBB20_41:
	beq r13, r15, .LBB20_53
.LBB20_42:
	blt r12, r16, .LBB20_53
.LBB20_43:
	addi r1, r0, 7
	lui r3, %hi(.L.str.17)
...
.LBB20_60:
	...
	jalr r0, r31, 0
.Lfunc_end20:
	.size	f77_open, .Lfunc_end20-f77_open
                                        # -- End function
...
.LBB21_33:
	...
	jal r0, .LBB21_29
.Lfunc_end21:
	.size	f77_close, .Lfunc_end21-f77_close
                                        # -- End function
...
.LBB23_10:
	...
	jalr r0, r31, 0
.Lfunc_end23:
	.size	fio_next_record, .Lfunc_end23-fio_next_record
                                        # -- End function
