...
#ifdef SLOW32_WREAD_DEBUG
    printf("W_AddFile: wad_file=%p lumpinfo=%p startlump=%d numlumps=%d\n",
           (void *)wad_file, (void *)lumpinfo, startlump, numlumps);
#endif
...
#ifdef SLOW32_WREAD_DEBUG
    printf("W_AddFile: lumpinfo[0].wad_file=%p lumpinfo[0].name=%.8s\n",
           (void *)lumpinfo[0].wad_file, lumpinfo[0].name);
#endif
