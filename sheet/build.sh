...
OBJECTS=""
for src in src/formula.c src/sheet.c src/wk1.c src/dbfio.c src/ui.c src/main.c; do
    base=$(basename "$src" .c)
...
echo -n "  Linking... "
$LD --mmio 64K --stack-size 128K --data-size 2M -o sheet.s32x \
    ../runtime/crt0.s32o \
    $OBJECTS \
...
echo "  ../tools/emulator/slow32-fast sheet.s32x"
